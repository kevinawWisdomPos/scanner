class DiscountItemLink {
  ...
  static List<DiscountItemLink> getDummy() {
    return [
      ...
      DiscountItemLink(discountId: 103, itemId: 40000, targetItemId: 40001),
      DiscountItemLink(discountId: 201, itemId: 40002),
      DiscountItemLink(discountId: 202, itemId: 40002),
      DiscountItemLink(discountId: 203, itemId: 40002),
      DiscountItemLink(discountId: 204, itemId: 40002),
      ...
      DiscountItemLink(discountId: 401, itemId: 40000),
      DiscountItemLink(discountId: 402, itemId: 40000),
    ];
  }
}
